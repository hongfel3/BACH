...
mu.build_empty_dir('logs_new')
call1 = TensorBoard(log_dir='logs_new')

call2 = ModelCheckpoint('best_val_acc_model_new.h5', monitor='val_acc', verbose=True, save_best_only=True)
call3 = ModelCheckpoint('best_val_loss_model_new.h5', monitor='val_loss', verbose=True, save_best_only=True)
