...
class normalizer(object):
    ...
    def transform(self, I):
        ...
        norm1 = ((I1 - means[0]) * (stds[0] / self.target_stds[0])) + self.target_means[0]
        norm2 = ((I2 - means[1]) * (stds[1] / self.target_stds[1])) + self.target_means[1]
        norm3 = ((I3 - means[2]) * (stds[2] / self.target_stds[2])) + self.target_means[2]
